...
export type DoesRoomLayoutMatchResultUnion = PiqClassHasNoRoomLayoutError | PiqClassNotLinkedError | RoomLayoutIdDoesNotMatchError | RoomLayoutStructureMatchResult;
...
export type DoesClassMatchPiqLayoutQuery = { __typename: 'Query', doesClassMatchPIQLayout: { __typename: 'PIQClassHasNoRoomLayoutError' } | { __typename: 'PIQClassNotLinkedError' } | { __typename: 'RoomLayoutIdDoesNotMatchError', currentRoomLayout?: { __typename: 'RoomLayout', id: string, name: string } | null, suggestedRoomLayout?: { __typename: 'RoomLayout', id: string, name: string } | null } | { __typename: 'RoomLayoutStructureMatchResult', matchesPIQRoomLayout: boolean } };
...
export type EditClassMutation = { __typename: 'Mutation', editClass: { __typename: 'EditClassSuccessResult', updated: boolean } | { __typename: 'PIQClassNotFoundError' } };
