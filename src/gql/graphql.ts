...
export type ClassInfo = {
  ...
  /** @deprecated Use roomLayout instead */
...
export type DoesRoomLayoutMatchResultUnion =
  | PiqClassHasNoRoomLayoutError
  | PiqClassNotLinkedError
  | RoomLayoutIdDoesNotMatchError
  | RoomLayoutStructureMatchResult
...
export type RoomLayoutIdDoesNotMatchError = Error & {
  ...
  code: Scalars['String']
  currentRoomLayout?: Maybe<RoomLayout>
  suggestedRoomLayout?: Maybe<RoomLayout>
  urlToCreateRoomLayout?: Maybe<Scalars['String']>
}

export type RoomLayoutStructureMatchResult = {
  __typename: 'RoomLayoutStructureMatchResult'
  matchesPIQRoomLayout: Scalars['Boolean']
  urlToFixRoomLayout?: Maybe<Scalars['String']>
}
...
export type SpotInfo = {
  __typename: 'SpotInfo'
  /** @deprecated The user info should be obtained from classInfo.enrollments and the same goes for the enrollmentId. The type BookedSpotUserInfo will be removed in the future. */
...
export type DoesClassMatchPiqLayoutQuery = {
  __typename: 'Query'
  doesClassMatchPIQLayout:
    ...
    | {
        __typename: 'RoomLayoutIdDoesNotMatchError'
        urlToCreateRoomLayout?: string | null
        currentRoomLayout?: { __typename: 'RoomLayout'; id: string; name: string } | null
        suggestedRoomLayout?: { __typename: 'RoomLayout'; id: string; name: string } | null
      }
    | {
        __typename: 'RoomLayoutStructureMatchResult'
        matchesPIQRoomLayout: boolean
        urlToFixRoomLayout?: string | null
      }
}
...
export type EditClassMutation = {
  __typename: 'Mutation'
  editClass:
    | { __typename: 'EditClassSuccessResult'; updated: boolean }
    | { __typename: 'PIQClassNotFoundError' }
}
...
export const DoesClassMatchPiqLayoutDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'doesClassMatchPIQLayout' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'site' } },
            ...
            selectionSet: {
              ...
              selections: [
                { kind: 'Field', name: { kind: 'Name', value: '__typename' } },
                {
                  ...
                  typeCondition: {
                    kind: 'NamedType',
                    name: { kind: 'Name', value: 'PIQClassHasNoRoomLayoutError' }
                  },
                  selectionSet: {
                    kind: 'SelectionSet',
                    selections: [{ kind: 'Field', name: { kind: 'Name', value: '__typename' } }]
                ...
                },
                {
                  ...
                  typeCondition: {
                    kind: 'NamedType',
                    name: { kind: 'Name', value: 'PIQClassNotLinkedError' }
                  },
                  selectionSet: {
                    kind: 'SelectionSet',
                    selections: [{ kind: 'Field', name: { kind: 'Name', value: '__typename' } }]
                ...
                },
                {
                  ...
                  typeCondition: {
                    kind: 'NamedType',
                    name: { kind: 'Name', value: 'RoomLayoutIdDoesNotMatchError' }
                  },
                  selectionSet: {
                    kind: 'SelectionSet',
                    selections: [
                      { kind: 'Field', name: { kind: 'Name', value: '__typename' } },
                      { kind: 'Field', name: { kind: 'Name', value: 'urlToCreateRoomLayout' } },
                      {
                        kind: 'Field',
                        name: { kind: 'Name', value: 'currentRoomLayout' },
                        selectionSet: {
                          kind: 'SelectionSet',
                          selections: [
                            { kind: 'Field', name: { kind: 'Name', value: '__typename' } },
                      ...
                      {
                        kind: 'Field',
                        name: { kind: 'Name', value: 'suggestedRoomLayout' },
                        selectionSet: {
                          kind: 'SelectionSet',
                          selections: [
                            { kind: 'Field', name: { kind: 'Name', value: '__typename' } },
                ...
                },
                {
                  ...
                  typeCondition: {
                    kind: 'NamedType',
                    name: { kind: 'Name', value: 'RoomLayoutStructureMatchResult' }
                  },
                  selectionSet: {
                    kind: 'SelectionSet',
                    selections: [
                      { kind: 'Field', name: { kind: 'Name', value: 'matchesPIQRoomLayout' } },
                      { kind: 'Field', name: { kind: 'Name', value: 'urlToFixRoomLayout' } }
                    ]
                  }
                }
              ]
...
} as unknown as DocumentNode<DoesClassMatchPiqLayoutQuery, DoesClassMatchPiqLayoutQueryVariables>
            ...
            selectionSet: {
              ...
              selections: [
                ...
                },
                {
                  ...
                  typeCondition: {
                    kind: 'NamedType',
                    name: { kind: 'Name', value: 'PIQClassNotFoundError' }
                  },
                  selectionSet: {
                    kind: 'SelectionSet',
                    selections: [{ kind: 'Field', name: { kind: 'Name', value: '__typename' } }]
