...
export type ClassInfoQuery = { __typename: 'Query', classInfo?: { __typename: 'ClassInfo', class: { __typename: 'Class', id: string, name: string, description: string, instructorName: string, start: any, startWithNoTimeZone: any, duration: number, waitListAvailable: boolean }, roomLayout?: { __typename: 'RoomLayout', id: string, name: string, matrix?: Array<{ __typename: 'BookableSpot', enabled?: boolean | null, x: number, y: number, icon: PositionIconEnum, spotInfo: { __typename: 'SpotInfo', spotNumber: number, isBooked: boolean } } | { __typename: 'IconPosition', x: number, y: number, icon: PositionIconEnum }> | null } | null, enrollments: Array<{ __typename: 'EnrollmentInfo', id: string, enrollmentStatus: EnrollmentStatusEnum, enrollmentDateTime: any, user?: { __typename: 'User', firstName: string, lastName: string, email: string, leaderboardUsername?: string | null } | null, spotInfo?: { __typename: 'SpotInfo', isBooked: boolean, spotNumber: number } | null }> } | null };
