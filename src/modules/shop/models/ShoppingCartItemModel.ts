...
import { type VariantFromCartItem, VariantModel } from '@/modules/shop/models/VariantModel'
...
export class ShoppingCartItemModel {
  ...
  constructor(gqlItem: GqlShoppingCartItem) {
    ...
    this.variant = new VariantModel(gqlItem.variant as unknown as VariantFromCartItem)
  }
